...
class GetDogsByBreedUseCase @Inject constructor(private val dogsRepository: DogsRepository) {
    operator fun invoke(breed: String): Flow<Result<List<Dog>>> {
        return dogsRepository.getDogsByBreed(breed)
    }
}
